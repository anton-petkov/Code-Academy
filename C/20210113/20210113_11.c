...
int main()
{
    ...
    printf("What quantity of tomatoes would you need? ");
    scanf("%f", &fTomatoWeight);

    printf("What quantity of flour would you need? ");
    scanf("%f", &fFlourWeight);

    printf("What quantity of candy would you need? ");
    scanf("%f", &fCandyWeight);

    printf("What quantity of yogurt would you need? ");
    scanf("%f", &fYogurtNum);

    printf("What quantity of lollipos would you need? ");
    scanf("%f", &fLollipopNum);

    printf("What quantity of icecream would you need? ");
